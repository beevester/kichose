...
class Client implements ClientInterface, SearchInterface, UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Opportunity", mappedBy="client", cascade={"persist"}, orphanRemoval=true)
     * @Groups({
     *     "document_read",
     *     "client_read",
     *     "client_write"
     ...
     */
    public function setOpportunities(ArrayCollection $opportunities): void
    {
