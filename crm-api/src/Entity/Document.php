...
class Document implements SearchInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Opportunity", mappedBy="documents")
     * @Groups({"document_read", "document_write"})
     * @ORM\OrderBy({"id" = "DESC"})
     */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Division", mappedBy="documents")
     * @Groups({"document_read", "document_write"})
     * @ORM\OrderBy({"id" = "DESC"})
     */
    private $divisions;
    ...
    public function removeOpportunity(Opportunity $opportunity): self
    {
        if ($this->opportunities->contains($opportunity)) {
            ...
            $opportunity->removeDocument($this);
        }
