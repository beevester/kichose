...
// Returns the private 'annotated_app_entity_task_api_platform_core_bridge_doctrine_orm_filter_order_filter' shared autowired service.
...
return $this->privates['annotated_app_entity_task_api_platform_core_bridge_doctrine_orm_filter_order_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\OrderFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, 'order', ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ['id' => NULL, 'status.id' => NULL, 'project.name' => NULL, 'project.client.name' => NULL, 'opportunitu.name' => NULL, 'opportunity.client.name' => NULL, 'assignee.name' => NULL, 'name' => NULL, 'timeEstimated' => NULL, 'timeSpent' => NULL, 'deadline' => NULL, 'createdAt' => NULL, 'updatedAt' => NULL], ($this->privates['serializer.name_converter.metadata_aware'] ?? $this->getSerializer_NameConverter_MetadataAwareService()));
