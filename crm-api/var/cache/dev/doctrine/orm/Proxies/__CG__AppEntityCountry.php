...
class Country extends \App\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'name', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'isActive'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIsActive(bool $isActive): \App\Entity\Country
    {
